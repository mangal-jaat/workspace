    ...
    <Sidebar.TabSubListItem>
      <Sidebar.TabSelect>
        <FormControl variant="standard">
          <InputLabel shrink>
            {t("sidebar.settings.general.language")}
          </InputLabel>
          <Select value={i18n.language} onChange={handleChange} displayEmpty>
            <MenuItemStyled value={settings.localization.values.en}>
              English
            </MenuItemStyled>
            <MenuItemStyled value={settings.localization.values.ru}>
              Русский
            </MenuItemStyled>
            <MenuItemStyled value={settings.localization.values.hi}>
              हिंदी
            </MenuItemStyled>
          </Select>
        </FormControl>
