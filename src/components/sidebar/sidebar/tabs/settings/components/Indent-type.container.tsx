...
export function IndentTypeSetting() {
  ...
  const initValue =
    getStorage(settings.indentType.storage) || settings.indentType.defaultValue;
    ...
    <Sidebar.TabSubListItem>
      <Sidebar.TabSelect>
        <FormControl variant="standard">
          <InputLabel shrink>
            {t("sidebar.settings.editor.indentType.title")}
          </InputLabel>
          <Select
            value={indentType.toString()}
            onChange={handleChange}
            displayEmpty
          >
            <MenuItemStyled
              value={settings.indentType.values.spaces.toString()}
            >
